...
const Herodao = () => {
  const { buttonPop, musdtBalance, bngxTreasuryBalance, listAmKpa, nftBalance, checkDelegate, GetTreasureBalanceNative } = useContext(ApeDaoContext);
      ...
      <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: false, amount: 0.25 }} className={`${styles.innerWidth} mx-auto flex flex-col`}>
        <div className="flex justify-center items-center flex-col relative z-10">
          ...
          <motion.div variants={textVariant(1.2)} className="flex flex-row justify-center items-center">
            <h1 className={styles.heroHeading}>Voting</h1>
            ...
            <div className=" w-full h-full md:w-full flex lg:flex-row flex-col  lg:w-full  lg:h-72 rounded-lg justify-between  ">
              <div className="w-[330px] md:w-[400px] lg:w-[500] text-gray-400 text-xs  p-4 lg:p-8    border-gray-300  rounded-lg h-64 items-center">
                ...
                <button
                  ...
                  className="flex shadow-xl bg-opacity-30 mt-8  lg:mt-[16px] mb-24 w-[130px] lg:w-[130px] bg-indigo-700 hover:bg-gradient-to-r from-indigo-500   via-pink-500 to-pink-500 p-[0.8rem]  items-center justify-center h-[40px]  rounded-lg cursor-pointer text-black"
                >
                  Delegate
                </button>
              </div>
              <div className="w-[330px] md:w-[400px] lg:w-[500] text-gray-400 text-xs  p-4 lg:p-8    border-gray-300  rounded-lg h-64 items-center">
                ...
                <div className="my-4">
                  <div className="font-bold">BNGX: {bngxTreasuryBalance?.toString()}</div>
                ...
                <div>
                  The amounts displayed above indicate the total funds held by the treasury. The treasury is programmed to releass a maximum of 5000BNGX and 1BNB per proposal which requires funding.
                  These ammounts may be reviewed upwards by the community.
                </div>
              </div>
            </div>
          </div>
