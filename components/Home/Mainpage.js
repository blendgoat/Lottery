...
const style = {
  ...
  timeContainer: `container justify-center w-full lg:w-full bg-indigo-900 shadow-xl rounded-lg mt-24 md:mt-48 lg:mt-24 xl:mt-48  items-center p-4 h-64 flex`,
  ...
  button: ` flex shadow-xl mb-24 w-4/5 bg:white hover:bg-gradient-to-r from-indigo-500   via-pink-500 to-pink-500  mt-24 md:mt-24 lg:mt-8 xl:mt-48 p-[0.8rem]  items-center justify-center h-16  rounded-lg cursor-pointer text-black`,
