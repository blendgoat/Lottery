...
const style = {
  ...
  detailsContainer: `w-[330px] md:w-[400px] lg:w-[500] text-xs text-[#5271ff] lg:text-base ml-4 p-16 lg:p-8 overflow-scroll   m-8 card rounded-lg h-48 shadow-xl items-center bg-indigo-900 `,
