...
const style = {
  ...
  timeContainer: `container justify-center w-4/5 lg:w-full  shadow-xl rounded-lg mt-32 md:mt-16 lg:mt-24 xl:mt-32 bg-gray-300 bg-opacity-30 flex-shrink-0  items-center p-4 h-32 lg:h-64 flex flex-row`,
    ...
    <div className="relative w-screen h-screen  p-4 lg:p-16 flex flex-col items-center">
      <div className={style.topContent}>
        <div className={style.nftImgContainer}>
          ...
          <div>
            <p>
              Game is currently closed and calculating winer. By entering the
