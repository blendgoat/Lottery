...
const style = {
  wrapper: `bg-slate-200  w-screen px-[1.2rem] py-[0.8rem] items-center flex h-20  `,
  ...
  headerItem: `text-black px-4 font-bold  hover:text-white cursor-pointer`,
    ...
    <div className={style.wrapper}>
      ...
      <Link href="/">
        <div className={style.logoContainer}>
          <div className={style.logoText}>bullionltt</div>
        </div>
      </Link>
      <>
